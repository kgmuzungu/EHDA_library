...
command_sequence_verify_how_much_dispensed = ["00PHN", "00DIS", "00RAT"]

command_sequence_stop = ["00STP"]

command_diameter_double_check = ["00dia1.3", "00.dia"] # response should be 00S1.300

command_sequence_defining_step_rate = ["00DIA1.3", "AL1", "BP1", "PF0", "00RUN",
                                       "FUNRAT", "RAT5UH", "VOL0.3", "00DIR", "DIRINF",
                                       "PHASE", "FUNRAT", "RAT5.5UH", "VOL5", "FUNSTP"]
