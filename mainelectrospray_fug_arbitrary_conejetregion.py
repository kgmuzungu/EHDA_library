...
def step_sequency(obj_fug_com, step_size=300, step_time=1, step_slope=0, voltage_start=0, voltage_stop=100):
    ...
    responses.append(FUG_sendcommands(obj_fug_com, ['>S0B 2']))
...
with obj_fug_com:
    ...
    if scp:
        txt_mode = "step"
        slope = 150  # V/s
        # cone jet at 6 for sure
        # the code will jump -1500V and +1500V from the cone-jet mode
        voltage_start = cone_jet_voltage - 1500
        voltage_stop = cone_jet_voltage + 1500
        step_size = 150
        step_time = 5
        ...
        try:
            ...
            for j in range(number_measurements):
                ...
                classification_monica = electrospray_classification.do_monica(max_data, quantity_max_data, percentage_max, Q)
...
if SAVE_CONFIG:
    ...
    if SAVE_JSON:
        ...
        file_name = txt_mode + name_setup + name_liquid + "_CONE JET REGION_" + Q + ".json"
