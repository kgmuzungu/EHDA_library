...
for i in directory_contents:
    res = re.search(current_shapes[2], i)
    if res == None:
        continue
    else:
        print(i)
...
plt.legend(loc='best')
plt.grid()
plt.savefig("C:/Users/hvvhl/Desktop/joao/EHDA_library/plot_generated/ganancalvo_"+current_shapes[2]+".svg", format='svg', dpi=300)
...
plt.legend(loc='best')
plt.savefig("C:/Users/hvvhl/Desktop/joao/EHDA_library/plot_generated/ganancalvo2_"+current_shapes[2]+".svg", format='svg', dpi=300)
...
plt.savefig("C:/Users/hvvhl/Desktop/joao/EHDA_library/plot_generated/boxplotsjaak_"+current_shapes[2]+".svg", format='svg', dpi=300)
...
ax1.axvspan(2.5, 1500, facecolor='green', alpha=0.1)
ax1.axvspan(0, 2.5, facecolor='red', alpha=0.1)
...
plt.show()
plt.savefig('C:/Users/hvvhl/Desktop/joao/EHDA_library/plot_generated/Sjaakdeviation_avg' + current_shapes[2] + ".jpg",
            format='jpg', dpi=300)
...
ytickNames = plt.setp(ax1, yticklabels=nameliquids)
ax1.axvspan(0, 5, facecolor='green', alpha=0.1)
ax1.axvspan(5, 50, facecolor='red', alpha=0.1)
...
plt.show()
plt.savefig('C:/Users/hvvhl/Desktop/joao/EHDA_library/plot_generated/Current [nA]' + current_shapes[2] + ".jpg",
            format='jpg', dpi=300)
...
ax1.axvspan(1.1, 2, facecolor='green', alpha=0.1)
ax1.axvspan(0.9, 1.1, facecolor='red', alpha=0.1)
plt.setp(ytickNames, rotation=45, fontsize=12)
plt.xticks(fontsize=14)
ax1.set_title('Sjaak avg / median η < 0.9 or avg / median η > 1.1 : '+current_shapes[2])
plt.show()
plt.savefig('Sjaakavg_media' + current_shapes[2] + ".jpg",
            format='jpg', dpi=300)

fig, axs = plt.subplots(index + 1)
values = ["  1: mean_value_array [5", " 2: med_value_array ]0"]
for j in range(index + 1):
...
"""for j in range(index + 1):
    ...
    ax1.set_ylabel(" mean_value_array ]2.5 ", color=color)
    ...
    plt.savefig("plot_mean_med"+str(name[j])+current_shapes[2]+".svg", format='svg', dpi=300)"""
...
for j in range(index + 1):
    ...
    ax2.tick_params(axis='y', labelcolor=color)
    plt.savefig("C:/Users/hvvhl/Desktop/joao/EHDA_library/plot_generated/plot_mean_med"+str(name[j])+current_shapes[2]+".svg", format='svg', dpi=300)
...
plt.savefig(
    "C:/Users/hvvhl/Desktop/joao/EHDA_library/plot_generated/plot_sjaak_std_mean_mean_median" + current_shapes[2] + str(
