...
#plt.savefig("C:/Users/hvvhl/PycharmProjects/EHDA/plot_generated/sjaak_mean" + name_liquid + ".jpg", format='jpg', dpi=300)

#plt.savefig('C:/Users/hvvhl/PycharmProjects/EHDA/plot_generated/sjaak_std_div_mean' + name_liquid + ".tiff", format='tiff', dpi=300)
#plt.savefig("C:/Users/hvvhl/PycharmProjects/EHDA/plot_generated/sjaak_std_div_mean" + name_liquid + ".jpg", format='jpg', dpi=300)
#plt.savefig('C:/Users/hvvhl/PycharmProjects/EHDA/plot_generated/logdeviation_div_meanXvoltage' + name_liquid[3] + ".jpg", format='jpg', dpi=300)
#plt.savefig('C:/Users/hvvhl/PycharmProjects/EHDA/plot_generated/logmean_div_medianXvoltage_' + name_liquid[3] + ".jpg", format='jpg', dpi=300)
plt.show()
