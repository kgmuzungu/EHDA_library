...
def model_check(knowledge, query):
    ...
    def check_all(knowledge, query, symbols, model):
        ...
        if not symbols:
            ...
            p = remaining.pop()  # pick one symbol at random

            # Create a model where the symbol is true
            model_true = model.copy()
            model_true[p] = True  # create two symbol when it is true

            # Create a model where the symbol is false
            model_false = model.copy()
            model_false[p] = False  # create two symbol when it is false

            # Ensure entailment holds in both models - recursion function : pick a new symbol
