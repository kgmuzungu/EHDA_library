...
Figures \ref{fig:dripping_camera_example}, \ref{fig:cone_camera_jet_example}, \ref{fig:multi_camera_jet_example} shows 3 spraying dynamics that we are most interesting in this project. 

\begin{multicols}{3}

  \begin{figure}[H]
      \center
      \includegraphics[width=2.9cm]{Figuras/drippingexample.png}
...
\begin{multicols}{3}
  ...
  \begin{figure}[H]
      \center
      \includegraphics[width=2.5cm]{Figuras/19:03/intermittent_example.png}
      \label{fig:intermittent_example}
      \caption{Intermittent 1}
  \end{figure}
  ...
  \begin{figure}[H]
      ...
      \caption{Microdripping / Intermittent 3}
  \end{figure}
...
\begin{multicols}{3}
  ...
  \begin{figure}[H]
      \center
      \includegraphics[width=2.2cm]{Figuras/april/conjet3.png}
      \label{fig:conjt3}
      \caption{Cone Jet 3}
  \end{figure}
